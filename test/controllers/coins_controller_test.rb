...
class CoinsControllerTest < ActionController::TestCase
  ...
  test "should create coin" do
    assert_difference('Coin.count') do
      post :create, coin: { acronym: @coin.acronym, description: @coin.description, url_image: @coin.url_image }
    end
  ...
  test "should update coin" do
    patch :update, id: @coin, coin: { acronym: @coin.acronym, description: @coin.description, url_image: @coin.url_image }
    assert_redirected_to coin_path(assigns(:coin))
  end
